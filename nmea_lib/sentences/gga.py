...
class GGASentence(PositionSentence, TimeSentence):
    ...
    def __init__(
        ...
        sentence_id: SentenceId = SentenceId.GGA,
    ):
    ...
    def _parse_fields(self, parser: SentenceParser) -> None:
        ...
        # Satellites in use
        self._satellites_in_use = parser.get_int_field(
            self.SATELLITES_IN_USE) or 0

        # Horizontal dilution
        self._horizontal_dilution = parser.get_float_field(
    ...
    def to_sentence(self) -> str:
        ...
        # Satellites in use
        builder.add_field(
            self._satellites_in_use if self._satellites_in_use > 0 else ""
        )
    ...
    def create(
        ...
        instance.set_satellites_in_use(satellites)
        instance.set_horizontal_dilution(hdop)
        instance.set_altitude(altitude)
        instance.set_geoidal_height(geoidal_height)
        instance.set_dgps_age(dgps_age)
        instance.set_dgps_station_id(dgps_station_id)
        return instance
