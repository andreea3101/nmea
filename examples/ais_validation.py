...
def test_nmea_sample_compliance():
    ...
    if sample_file.exists():
        ...
        aivdm_samples = [line.strip()
                         for line in lines if line.startswith("!AIVDM")]
        ...
        if aivdm_samples:
            ...
            for i, sample in enumerate(aivdm_samples[:5]):
                ...
                if len(parts) >= 7:
                    ...
                    print(
                        f"      Parts: {part_num}/{total_parts}, Channel: {channel}, Payload: {
                            len(payload)} chars, Fill: {fill_bits}")
...
def test_checksum_validation():
    ...
    test_sentences = [
        ...
        # Valid multi-part
        "!AIVDM,2,1,1,A,53HOI:000003BG?A59?BG?@3JG?>F`00000000160000040Hl0000000,0*69",
    ]
